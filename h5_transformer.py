...
def calc_overlap(database_region, query_region):
    valid_region = []
    valid_region.append(max(database_region[0], query_region[0]))
    valid_region.append(max(database_region[1], query_region[1]))
    valid_region.append(min(database_region[2], query_region[2]))
    valid_region.append(min(database_region[3], query_region[3]))
    ...
    if args.region_num == 2:
        if split == 'train':
            ...
            database_queries_region = [valid_region[0] + args.crop_width//2,
                                    (valid_region[1] + valid_region[3])//2 + args.crop_width//2,
                                    valid_region[2] - args.crop_width//2,
                                    valid_region[3] - args.crop_width//2]
