...
if args.use_extended_data:
    extended_ds = None
    extended_ds = datasets_ws.TripletsDataset(args, args.datasets_folder, args.dataset_name, "extended", args.negs_num_per_query)
logging.info(f"Extended query set: {extended_ds}")
